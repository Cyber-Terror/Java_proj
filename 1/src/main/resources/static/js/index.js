load = async () => {
    ...
    if(length == 3)
    {
        ...
        ulk2.innerHTML += "<button type=\"button\" id=\"but\" class=\"btn btn-secondary btn-lg btn-block\" onclick='onPlayerPage()' style=\"margin-left: 35px; margin-bottom: 20px; height: 50px; width:280px; background: dodgerblue\"></button>";
        document.getElementById("but").innerHTML = "TO CLIENT PAGE";
    }else
    {
        let ulk2 = document.getElementById("buttt");
        ulk2.innerHTML += "<button type=\"button\" id=\"but\" class=\"btn btn-secondary btn-lg btn-block\" onclick='onAdminPage()' style=\"margin-left: 35px; margin-bottom: 20px; height: 50px; width:280px; background: dodgerblue\"></button>";
